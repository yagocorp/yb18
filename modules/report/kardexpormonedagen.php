...
<?php
		...
		public.f_get_ultimocierrefecha_id(r.pventa_id, r.registro_fecha::date) as ultimocierre_id
...
?>
        <div class="pd-5 c-gray">no tiene operaciones registradas</div>   
<?php   else:?>
        ...
        <?php
            ...
            while ($d = $q->Read()) {
				...
				if ($rstate == '1') {
					...
					} else if ($d['ultimocierre_id']!=$d['registro_id'])  {
						$saldo += floatval($d['registro_det_importe']);
					}
				} 
