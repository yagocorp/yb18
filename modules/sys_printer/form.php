		...
		<form id="<?=$prefix?>_frm" name="<?=$prefix?>_frm" onsubmit="return false;">
			...
			<tr align="left" valign="top">
				...
				<td class="frm-pd" colspan="3">
					<input id="<?=$prefix?>_nombre" type="text" name="nombre" value="<?=$r['nombre']?>" size="70"/>
				</td>
			</tr>
			<tr align="left" valign="top">
...
?>
			...
			<tr align="left" valign="top">
				<td class="frm-pd" colspan="4">
					<textarea name="actionscript" class="fs-10" style="font-family: 'courier new'!important; width: 450px; height: 100px;"><?=$r['actionscript']?></textarea>
				</td>
			</tr>
			</table>
		</form>
